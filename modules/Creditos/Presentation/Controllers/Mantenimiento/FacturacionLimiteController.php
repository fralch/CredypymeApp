...
use Modules\Creditos\Infrastructure\Persistence\Eloquent\Mantenimiento\Facturacion\Limite;
use Modules\Creditos\Infrastructure\Persistence\Eloquent\Mantenimiento\Facturacion\LimiteDetalle;
    ...
    public function generar_limite_diario($fecha_actual_corta, $fecha_nueva_corta, $agencia_id)
    {
        ...
        if ($limite_diario_actual == null) {
            ...
            foreach ($limite_actual_detalle as $item) {
                ...
                if ($dia_semana_nuevo == 0) {
                    ...
                    if ($item->agencia_id == 2) {
                        $nuevo_porcentaje = 0.65; // HUANCAYO
                    } else if ($item->agencia_id == 3) {
                        $nuevo_porcentaje = 0.35; // PAMPAS
                    } else {
                        $nuevo_porcentaje = 0;
                    }
            ...
            if ($dia_semana_nuevo == 0) {
                ...
                if ($agencia_id == 2) {
                    $porcentaje_limite = 0.65; // HUANCAYO
                } else if ($agencia_id == 3) {
                    $porcentaje_limite = 0.35; // PAMPAS
                } else {
                    $porcentaje_limite = 0;
                }

...
use Modules\Creditos\Presentation\Controllers\Clientes\GrupoController;
use Modules\Creditos\Presentation\Controllers\Clientes\ParienteController;
use Modules\Creditos\Presentation\Controllers\Clientes\AvalController;
use Modules\Creditos\Presentation\Controllers\Clientes\NegocioController;
use Modules\Creditos\Presentation\Controllers\Clientes\ClienteHistorialCrediticioController;
use Modules\Creditos\Presentation\Controllers\Clientes\ClientePrendasController;
use Modules\Creditos\Presentation\Controllers\Clientes\AlbumFotosController;
use Modules\Creditos\Presentation\Controllers\Clientes\ClienteMovimientoController;
use Modules\Creditos\Presentation\Controllers\Clientes\ClienteTransferenciaController;
// ----------------CRÉDITOS--------------------------------------------
use Modules\Creditos\Presentation\Controllers\Credito\EvaluacionFinancieraController;
use Modules\Creditos\Presentation\Controllers\Caja\DesembolsoController;
use Modules\Creditos\Presentation\Controllers\Credito\PropuestaController;
use Modules\Creditos\Presentation\Controllers\Credito\AprobacionController;
use Modules\Creditos\Presentation\Controllers\Credito\CreditoDocumentoFinancieroController;
use Modules\Creditos\Presentation\Controllers\Credito\CronogramaController;
use Modules\Creditos\Presentation\Controllers\Credito\CreditoPagoVoucherController;
use Modules\Creditos\Presentation\Controllers\Credito\CarritoController;
use Modules\Creditos\Presentation\Controllers\Credito\CarritoSeguimientoController;
// --------------------GRUPAL--------------------------------------------
use Modules\Creditos\Presentation\Controllers\Grupal\SolicitudController;
use Modules\Creditos\Presentation\Controllers\Grupal\AprobacionController as GrupoAprobacionController;
use Modules\Creditos\Presentation\Controllers\Grupal\DesembolsoController as GrupoDesembolsoController;
use Modules\Creditos\Presentation\Controllers\Grupal\DocumentoController as GrupoDocumentoController;

//-----------------------------INVERSIONES-------------------------------
use Modules\Creditos\Presentation\Controllers\Inversion\InversionController;
use Modules\Creditos\Presentation\Controllers\Inversion\InversionMetaController;

// ----------------CAJA--------------------------------------------
use Modules\Creditos\Presentation\Controllers\Caja\CajaController;
use Modules\Creditos\Presentation\Controllers\Caja\CajaTransaccionController;
use Modules\Creditos\Presentation\Controllers\Caja\CajaAdelantoHaberController;
use Modules\Creditos\Presentation\Controllers\Caja\CajaTransferenciaController;
use Modules\Creditos\Presentation\Controllers\Caja\CajaOperacionDiaController;
use Modules\Creditos\Presentation\Controllers\Caja\FacturacionController;
use Modules\Creditos\Presentation\Controllers\Caja\CajaCobranzaController;
use Modules\Creditos\Presentation\Controllers\Caja\CajaPagoCuotaController;
use Modules\Creditos\Presentation\Controllers\Caja\CajaPagoMoraController;
use Modules\Creditos\Presentation\Controllers\Caja\CajaPagoNotificacionController;
use Modules\Creditos\Presentation\Controllers\Caja\CajaFaltantesController;
use Modules\Creditos\Presentation\Controllers\Caja\CajaCierreDiaController;
use Modules\Creditos\Presentation\Controllers\Caja\CajaCierreController;
use Modules\Creditos\Presentation\Controllers\Caja\CajaTransferenciaPagoController;
use Modules\Creditos\Presentation\Controllers\Caja\CarritoCobranzaController;

// ----------------CUENTA--------------------------------------------
use Modules\Creditos\Presentation\Controllers\Cuenta\CuentaController;
use Modules\Creditos\Presentation\Controllers\Cuenta\CuentaMovimientoController;
use Modules\Creditos\Presentation\Controllers\Cuenta\CuentaTransferenciaController;
use Modules\Creditos\Presentation\Controllers\Cuenta\CuentaEnvioController;
use Modules\Creditos\Presentation\Controllers\Cuenta\CuentaBancariaController;

// ----------------HERRAMIENTAS--------------------------------------------
use Modules\Creditos\Presentation\Controllers\Herramientas\SimuladorCreditosController;
use Modules\Creditos\Presentation\Controllers\Herramientas\SimuladorRiesgoController;
use Modules\Creditos\Presentation\Controllers\Herramientas\CambioAgenciaController;
use Modules\Creditos\Presentation\Controllers\Herramientas\IndicadorObjetivoController;
use Modules\Creditos\Presentation\Controllers\Herramientas\MensajeriaController;
// -----------------REPORTES-------------------------
use Modules\Creditos\Presentation\Controllers\Reportes\ReporteAdelantoController;
use Modules\Creditos\Presentation\Controllers\Reportes\ReporteCobranzasController;
use Modules\Creditos\Presentation\Controllers\Reportes\ReporteCobranzasTipoController;
use Modules\Creditos\Presentation\Controllers\Reportes\ReporteClientesController;
use Modules\Creditos\Presentation\Controllers\Reportes\ReporteDesembolsoController;
use Modules\Creditos\Presentation\Controllers\Reportes\ReporteDiasMoraController;
use Modules\Creditos\Presentation\Controllers\Reportes\ReporteControlMoraController;
use Modules\Creditos\Presentation\Controllers\Reportes\ReporteTransaccionesController;
use Modules\Creditos\Presentation\Controllers\Reportes\ReporteCompromisoNotificacionesController;
use Modules\Creditos\Presentation\Controllers\Reportes\ReporteEquifaxController;
use Modules\Creditos\Presentation\Controllers\Reportes\ReporteCanceladosController;
use Modules\Creditos\Presentation\Controllers\Reportes\ReporteMoraController;
use Modules\Creditos\Presentation\Controllers\Reportes\ReporteMoraAgenciaController;
use Modules\Creditos\Presentation\Controllers\Reportes\ReporteCajaController;
use Modules\Creditos\Presentation\Controllers\Reportes\ReporteOperacionesController;
use Modules\Creditos\Presentation\Controllers\Reportes\ReporteEnvioController;
use Modules\Creditos\Presentation\Controllers\Reportes\ReporteFacturacionController;
use Modules\Creditos\Presentation\Controllers\Reportes\ReporteAprobacionController;
use Modules\Creditos\Presentation\Controllers\Reportes\ReporteProductividadController;
use Modules\Creditos\Presentation\Controllers\Reportes\ReporteInversionMetaController;
use Modules\Creditos\Presentation\Controllers\Reportes\ReporteClienteMovimientoController;
use Modules\Creditos\Presentation\Controllers\Reportes\ReporteClienteTransferenciaController;
use Modules\Creditos\Presentation\Controllers\Reportes\ReporteBancoController;

// ----------------MANTEMINIENTOS--------------------------------------------
use Modules\Creditos\Presentation\Controllers\Mantenimiento\TransaccionCategoriaController;
use Modules\Creditos\Presentation\Controllers\Mantenimiento\TransaccionSubcategoriaController;
use Modules\Creditos\Presentation\Controllers\Mantenimiento\TransaccionComprobanteController;
use Modules\Creditos\Presentation\Controllers\Mantenimiento\Credito\CreditoSectorController;
use Modules\Creditos\Presentation\Controllers\Mantenimiento\Credito\CreditoProductoController;
use Modules\Creditos\Presentation\Controllers\Mantenimiento\Credito\CreditoSubproductoController;
use Modules\Creditos\Presentation\Controllers\Mantenimiento\Credito\CreditoTipoController;
use Modules\Creditos\Presentation\Controllers\Mantenimiento\Credito\CreditoGarantiaController;
use Modules\Creditos\Presentation\Controllers\Mantenimiento\Credito\CreditoEstadoController;
use Modules\Creditos\Presentation\Controllers\Mantenimiento\FacturacionLimiteController;
use Modules\Creditos\Presentation\Controllers\Mantenimiento\ProductosMetaController;

// ----------------EXTERNA--------------------------------------------
use Modules\Creditos\Presentation\Controllers\Caja\CajaCobranzaExternaController;
use Modules\Creditos\Presentation\Controllers\Inversion\InversionMetaExternaController;

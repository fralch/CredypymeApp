...
use App\Http\Controllers\Gth\Usuarios\HorarioAsignadoController;
use App\Http\Controllers\Gth\Usuarios\CesadoController;
use App\Http\Controllers\Gth\Asistencias\AsistenciaController;
use App\Http\Controllers\Gth\Asistencias\TokenController;

use App\Http\Controllers\Gth\Asistencias\TardanzaController;
use App\Http\Controllers\Gth\Asistencias\FaltaController;
use App\Http\Controllers\Gth\Asistencias\AsistenciaGeneralController;
use App\Http\Controllers\Gth\Asistencias\JustificacionController;
use App\Http\Controllers\Gth\Asistencias\LicenciaController;
use App\Http\Controllers\Gth\Asistencias\PermisoController;

use App\Http\Controllers\Gth\Mantenimiento\HorarioController;
use App\Http\Controllers\Gth\Mantenimiento\PlanillaSistPensioneController;
use App\Http\Controllers\Gth\Mantenimiento\CerrarDiaGthController;
use App\Http\Controllers\Gth\Mantenimiento\LicenciaCategoriaController;


// -----------------COLABORADOR DEL MES---------------------------------------------
use App\Http\Controllers\Gth\ColaboradorMes\ColaboradorMesController;
use App\Http\Controllers\Gth\ColaboradorMes\ColaboradorMesPreguntaController;
use App\Http\Controllers\Gth\ColaboradorMes\ColaboradorMesCategoriaController;
use App\Http\Controllers\Gth\ColaboradorMes\ColaboradorMesNivelController;
use App\Http\Controllers\Gth\ColaboradorMes\ColaboradorMesEquipoController;
use App\Http\Controllers\Gth\ColaboradorMes\ColaboradorMesEquipoIntegranteController;
use App\Http\Controllers\Gth\ColaboradorMes\ColaboradorMesExamenController;
use App\Http\Controllers\Gth\ColaboradorMes\ColaboradorMesExamenPreguntaController;
use App\Http\Controllers\Gth\ColaboradorMes\ColaboradorMesResultadosController;
use App\Http\Controllers\Gth\ColaboradorMes\ColaboradorMesSeguimientoController;



use App\Http\Controllers\Gth\ColaboradorMes\ColaboradorMesEvaluacionController;
use App\Http\Controllers\Gth\ColaboradorMes\ColaboradorMesEvaluacionPreguntaController;
//-------------------PLANILLAS -----------------------------------------------------
use App\Http\Controllers\Gth\Planillas\PlanillaGeneraleController;
use App\Http\Controllers\Gth\Planillas\PlanillaUsuarioController;
...
use App\Http\Controllers\Gth\Planillas\PlanillaVacacioneDetalleController;

use App\Http\Controllers\Apis\ApiSolicitudController;

...
use App\Http\Controllers\Logistica\LogisticaResponsableController;
use App\Http\Controllers\Logistica\LogisticaEstadoController;
use App\Http\Controllers\Logistica\LogisticaCondicionController;
// -------------------GESTIÓN DE ACTIVOS--------------------------------------------
use App\Http\Controllers\Logistica\Activos\ActivoInventarioController;
use App\Http\Controllers\Logistica\Activos\ActivoAsignacionController;
use App\Http\Controllers\Logistica\Activos\ActivoCategoriaController;
use App\Http\Controllers\Logistica\Activos\ActivoNombreController;
use App\Http\Controllers\Logistica\Activos\ActivoTipoController;
use App\Http\Controllers\Logistica\Activos\ActivoEnvioController;
use App\Http\Controllers\Logistica\Activos\ActivoUbicacionController;
use App\Http\Controllers\Logistica\Activos\ActivoCompraController;
use App\Http\Controllers\Logistica\Activos\ActivoRecordController;
use App\Http\Controllers\Logistica\Activos\ActivoVentaController;
// -------------------GESTIÓN DE SUMINISTROS-----------------------------------------
use App\Http\Controllers\Logistica\Suministros\SuministroAlmacenController;
use App\Http\Controllers\Logistica\Suministros\SuministroAsignacionController;
use App\Http\Controllers\Logistica\Suministros\SuministroDevolucionController;
use App\Http\Controllers\Logistica\Suministros\SuministroCompraController;
use App\Http\Controllers\Logistica\Suministros\SuministroEnvioController;
use App\Http\Controllers\Logistica\Suministros\SuministroTipoController;
use App\Http\Controllers\Logistica\Suministros\SuministroProveedorController;
use App\Http\Controllers\Logistica\Suministros\SuministroMedicionController;
use App\Http\Controllers\Logistica\Suministros\SuministroOperacionesController;
use App\Http\Controllers\Logistica\Suministros\SuministroVentaController;

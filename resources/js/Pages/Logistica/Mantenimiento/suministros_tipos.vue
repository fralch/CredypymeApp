<template>
	<layout ref="layout">
		<div class="slot_body slot-suministros-tipos" slot="component-view">
			<div class="content" style="display: block">
				<div class="card">
					<headerClose :title="'TIPOS DE SUMINISTROS'"></headerClose>
			...
			if (this.$v.frmDatosTipo.$invalid) {
				...
				Swal.fire({
					...
					if (result.isConfirmed) {
						axios
							.post(route("log.man.sum_tipos.verificar"), self.frmDatosTipo)
							.then(function (response) {
								if (response.data == "EXISTE") {
									...
									self.$inertia.post(
										route("log.man.sum_tipos.guardar"),
										self.frmDatosTipo,
										{
											preserveScroll: true,
											onStart: (visit) => {

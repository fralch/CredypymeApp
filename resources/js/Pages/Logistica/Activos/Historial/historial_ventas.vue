							...
							>
								...
								<tbody>
									...
									>
										...
										<td class="table-bordered" align="right">
											{{ roundTo(item.valor_venta - item.valor_actual, 2) }}
										</td>
									</tr>
								</tbody>
							</table>
	...
	methods: {
		...
		Buscar() {
			...
			if (
				...
				axios
					.post(route("log.act.historial_ventas.buscar"), data)
		...
		Descargar(documento) {
			let self = this;
			let source =
				"/imagenes_server/logistica/activos/ventas/" + documento + "";
			axios

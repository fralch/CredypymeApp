					...
					<div class="card-body card-block">
						<div class="form-row">
							...
							<div class="input-group col-md-3 mb-1 mt-1 col-6">
								<div class="input-group-prepend">
									<span class="input-group-text prepend-title">CAP.</span>
								...
								<input
									...
									:value="roundTo(datos_credito.capital_total, 2)"
									onkeydown="return false"
									spellcheck="false"
								/>
							</div>
							<div class="input-group col-md-4 mb-1 mt-1">
								<div class="input-group-prepend">
									<span class="input-group-text prepend-title">FECHA DES.</span>
								</div>
							...
							<div class="input-group col-md-4 mb-1 mt-1 col-7">
								<div class="input-group-prepend">
									<span class="input-group-text prepend-title">PLA.</span>
								</div>
							...
							>
								<div class="input-group-prepend">
									<span class="input-group-text prepend-title">FRE.</span>
								</div>
							...
							<div class="input-group col-md-2 mb-1 mt-1 col-5">
								<div class="input-group-prepend">
									<span class="input-group-text prepend-title">TIP.</span>
								</div>
							...
							>
								<div class="input-group-prepend">
									<span class="input-group-text prepend-title">PRODUCTO</span>
								</div>
							...
							>
								...
								<input
									...
									class="form-control center input-information"
									:value="
										datos_credito.pago_oficina == 1 ? 'OFICINA' : 'NEGOCIO'
									"
									onkeydown="return false"
									spellcheck="false"
								/>
							...
							<div class="input-group col-md-3 col-12 mb-1 mt-1">
								<div class="input-group-prepend">
									<span class="input-group-text prepend-title">TEL.:</span>
								</div>
							...
							<div class="input-group col-md-3 col-12 mb-1 mt-1">
								<div class="input-group-prepend">
									<span class="input-group-text prepend-title">ENVIAR A:</span>
								</div>
							...
							<div class="col-md-1 col-2 offset-5" v-if="boton_panel">
								<button
						...
						<div class="form-row mt-1">
							...
							<div class="col-md-8">
									...
									<table class="table" id="tblCuotasDetalle">
										<thead>
											<tr>
												...
												<th style="max-width: 80px !important">DÍAS_ATRASO</th>
											</tr>
										</thead>
										<tbody>
											<tr
											...
											>
												...
												<td align="right">
													{{
														item.acumulado != null ? "S/ " + item.acumulado : ""
													}}
												</td>
												<td align="right">
									...
									<legend>
										<div class="form-check">
											<input
												...
												:disabled="!edicion || this.cancelacion"
											/>
											<label
												class="label-title p-1"
												for="chbPagoCuotas"
									...
									<div class="form-row" v-if="frmDatosCobranza.pago_cuota">
										...
										<div class="input-group col-md-8 mb-3">
											...
											<div
												...
												v-if="this.frmDatosCobranza.forma_pago == 'por_monto'"
											>
								...
								<div class="form-row">
									...
									<div class="form-group col-md-4 col-12">
										<fieldset class="p-0 pt-2 pl-3 pr-2">
											...
											<div class="text-center" v-if="!edicion && modo != 'VER'">
												<button
													class="btn btn-action btn-icon-split"
													style="
								...
								<div v-show="this.frmDatosCobranza.pago_notificaciones == true">
									<div class="form-row">
	...
	methods: {
				...
				.then((response) => {
					...
					if (resultado) {
						...
						let object = {
							...
							pago_cantidad_cuota: this.carrito_detalle.pago_cantidad_cuota,
							pago_cuota_monto: this.carrito_detalle.pago_cuota_monto,
							...
							pago_mora_monto: this.carrito_detalle.pago_mora_monto,
							pago_notificaciones: this.carrito_detalle.pago_notificaciones,
		...
		ResetearCampos() {
			if (this.carrito_detalle != null) {
				...
				this.frmDatosCobranza.pago_monto = this.carrito_detalle.pago_monto;
				this.frmDatosCobranza.pago_mora_monto =
					this.carrito_detalle.pago_mora_monto;
				this.frmDatosCobranza.pago_notificaciones_monto =
					this.carrito_detalle.pago_notificaciones_monto;
				this.frmDatosCobranza.total_cobro = this.carrito_detalle.total_cobro;
				...
				this.frmDatosCobranza.modo_envio = this.carrito_detalle.modo_envio;
			} else if (this.carrito_detalle == null) {
				this.edicion = true;
			...
			if (this.nuevo_telefono_principal != this.telefono_principal) {
				...
				Swal.fire({
					...
					preConfirm: () => {
						...
						data.append("cliente_id", this.datos_credito.cliente_id);
						data.append("agencia_id", this.datos_credito.agencia_id);
						data.append("nuevo_telefono", this.nuevo_telefono_principal);

						// this.$inertia.post(route("cre.carrito.actualizar_telefono"), data);
						// return false;

						return axios
							.post(route("cre.carrito.actualizar_telefono"), data)
							.then(() => {
								self.editar_numero = false;
								self.telefono_principal = self.nuevo_telefono_principal;
							})
							.catch((error) => {
			...
			if (this.edicion == true) {
					...
					if (
						...
						if (this.frmDatosCobranza.forma_pago == "por_cuota") {
							mensaje +=
								...
								" ";
						} else if (this.frmDatosCobranza.forma_pago == "por_monto") {
							mensaje +=
								"MONTO=S/ " +
				...
				Swal.fire({
					...
					if (result.isConfirmed) {
						...
						if (this.modo == "EDITAR") {
							data.append("carrito_detalle_id", this.carrito_detalle_id);
							data.append(
								"carrito_detalle_aud",
						...
						data.append("agencia_carrito", this.mi_carrito.agencia_id);
						data.append("carrito_id", this.mi_carrito.id);
						data.append("agencia_credito", this.datos_credito.agencia_id);
						data.append("credito_id", this.credito_id);
						data.append("cliente_id", this.datos_credito.cliente_id);
						data.append("telefono_principal", this.telefono_principal);
						data.append("modo_envio", this.frmDatosCobranza.modo_envio);

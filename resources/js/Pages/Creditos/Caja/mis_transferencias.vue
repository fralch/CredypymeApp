	...
	<layout ref="layout">
		...
		>
			<div class="content" style="display: block">
				<div class="card">
					<headerClose :title="'MIS TRANSFERENCIAS - CAJA'"></headerClose>
...
export default {
	...
	methods: {
		...
		RutaConfirmar(data) {
			this.$inertia.post(route("caj.mis_transferencias.confirmar"), data, {
				preserveScroll: true,
				onStart: () => {
					Swal.fire({
						title: "REGISTRANDO",

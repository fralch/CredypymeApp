                        ...
                        <TabView>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6 col-6">
                                        ...
                                        <textarea
                                            ...
                                            rows="2"
                                            :value="
                                                datos_aprobacion.comentario_propuesta
                                            "
                                            readonly
                                        ></textarea>
                                    </div>
                                    <div class="form-group col-md-6 col-6">
                                        ...
                                        <textarea
                                            ...
                                            rows="2"
                                            :value="
                                                datos_aprobacion.comentario_aprobacion
                                            "
                                            readonly
                                        ></textarea>
                                    </div>
                                    <div class="form-row col-md-7">
                                        ...
                                        <div class="col-md-6 col-6">
                                            ...
                                            <input
                                                class="form-control center"
                                                :value="
                                                    datos_aprobacion.usuario_asesor
                                                "
                                                type="text"
                                                readonly
                                            />
                                        ...
                                        <div
                                            class="input-group col-md-12 col-6"
                                        >
                                            <div class="input-group-prepend">
                                                <div
                                                    class="input-group-text"
                                        ...
                                        <div
                                            ...
                                            v-if="
                                                datos_aprobacion.considerado_uno ==
                                                1
                                            "
                                        >
                                            <label
                                    ...
                                    <div class="form-row col-md-4 col-12">
                                        ...
                                        <div class="col-md-12 col-6">
                                            ...
                                            <input
                                                ...
                                                class="form-control"
                                                :value="
                                                    datos_aprobacion.apellido_paterno
                                                "
                                                readonly
                                            />
                                        </div>
                                        <div class="col-md-12 col-6">
                                            ...
                                            <input
                                                ...
                                                class="form-control"
                                                :value="
                                                    datos_aprobacion.apellido_materno
                                                "
                                                readonly
                                            />
                                        </div>
                            ...
                            <TabPanel header="GARANTÍA"
                                ><div class="form-row">
                                    ...
                                    <div class="col-md-12">
                                        <label class="label-title"
                                            >COMENTARIO DE GARANTÍA</label
                                        >
                                        <textarea
                                            class="form-control text-row"
                                            rows="2"
                                            :value="
                                                datos_aprobacion.comentario_garantia
                                            "
                                            readonly
                                        ></textarea>
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="col-md-6">
                                        ...
                                        <input
                                            ...
                                            class="form-control center"
                                            :value="
                                                comision_seleccionada.nombre_comision
                                            "
                                            disabled
                                        />
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <input
                                            ...
                                            step="0.1"
                                            v-model.number="
                                                comision_seleccionada.monto_cobrar
                                            "
                                            :min="
                                                comision_seleccionada.monto_minimo
                                            "
                                            @change="Redondear"
                                            style="
                                                font-size: 15px;

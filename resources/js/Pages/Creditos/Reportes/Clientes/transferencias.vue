<template>
	<layout ref="layout">
		<div
			class="slot_body slot-reporte-clientes-transferencias"
			slot="component-view"
		>
			<div class="content" style="display: block">
				<div class="card">
					<headerClose :title="'TRANSFERENCIAS DE CLIENTES'"></headerClose>
						...
						<table class="table" id="tblTransferencias" width="100%">
							<thead>
								<tr>
									...
									<th style="min-width: 120px !important">AGENCIA_ORIGEN</th>
									<th style="min-width: 12px !important">ASESOR_ORIGEN</th>
									<th style="min-width: 120px !important">AGENCIA_DESTINO</th>
									<th style="min-width: 120px !important">ASESOR_DESTINO</th>
									<th style="min-width: 100px !important">EVAL_FINANCIERA</th>
									<th style="min-width: 100px !important">ALBUM_FOTOS</th>
									<th style="min-width: 120px !important">FECHA</th>
							...
							<tbody>
								...
								>
									...
									<td align="center">
										{{ item.evaluacion_financiera == 1 ? "SI" : "NO" }}
									</td>
									<td align="center">
										{{ item.album_fotos == 1 ? "SI" : "NO" }}
									</td>
									<td align="center">
	...
	methods: {
		...
		Buscar() {
			...
			Swal.fire({
				...
				didOpen: () => {
					Swal.showLoading();
					// this.$inertia.post(route("rep.cli.transferencias.buscar"), data);
					axios
						.post(route("rep.cli.transferencias.buscar"), data)
		...
		Exportar(tipo) {
			...
			Swal.fire({
				...
				didOpen: () => {
					Swal.showLoading();
					axios
						.post(route("rep.cli.transferencias.exportar"), data)
						.then(function (response) {
							if (tipo == "XLSX") {
								let linkSource =
								...
								let fileName = "rptClientesTransferencias.xlsx";
...
<style lang="css">
.slot-reporte-clientes-transferencias {
	width: 65% !important;

    ...
    <layout ref="layout">
        <div class="slot_body slot_listado_registro" slot="component-view">
            <div class="content" style="display: block">
                <div class="card">
                    <headerClose
                        :title="'LISTADO Y REGISTRO DE CLIENTES'"
                    ></headerClose>
                    ...
                    <div class="card-body card-block">
                        <TabView>
                            <TabPanel header="CLIENTES">
                                <div
                                    class="form-row row justify-content-md-center"
                                >
                                    ...
                                    <div class="form-group col-md-2 col-4">
                                        <div class="form-check">
                                            ...
                                            <label
                                                class="label-title"
                                                for="rdbExpedienteListadoRegistro"
                                                >EXPEDIENTE
                                            </label>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-2 col-4">
                                        <div class="form-check">
                                            ...
                                            <label
                                                class="label-title"
                                                for="rdbDireccionListadoRegistro"
                                                >DIRECCIÓN
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body card-block">
                                    <div class="form-row">
                                        ...
                                        <div
                                            class="respon col-md-4 col-12 offset-md-1"
                                        >
                                            <div class="input-group">
                                                <div
                                                    class="input-group-prepend"
        ...
        permiso_eliminar_cliente() {
            ...
            let permiso_detalle =
                this.$inertia.page.props.user_permissions.permisos_detalle.filter(
                    (item) =>
                        item.permiso == "CREDITOS_CLIENTES/ELIMINAR_CLIENTE",
                );
    ...
    methods: {
        ...
        Nuevo() {
            ...
            axios
                ...
                .then(function (response) {
                    mdlDatosPersonales.lista_asesores_promotores =
                        response.data;
        ...
        async ParientesAvalesNegocio(item) {
            let mdlParientesAvalesNegocios =
                this.$refs.mdlParientesAvalesNegocios;

            mdlParientesAvalesNegocios.frmParienteAval.cliente_id = item.id;
            mdlParientesAvalesNegocios.frmParienteAval.agencia_id =
                item.agencia_id;

                ...
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            >
                                <fieldset>
                                    ...
                                    <div class="form-row">
                                                ...
                                                <form autocomplete="off">
                                                    <div class="input-group">
                                                        <input
                                                            ...
                                                            "
                                                            :disabled="
                                                                frmDatosCliente.apellido_paterno !=
                                                                null
                                                            "
                                                        />
                                                        <div
                                            ...
                                            >
                                                ...
                                                <form autocomplete="off">
                                                    <textarea
                                                        ...
                                                        class="form-control"
                                                        :value="
                                                            frmDatosCliente.apellido_materno
                                                        "
                                                        disabled
                                                        readonly
                                                    >
                                        ...
                                        <div class="form-row col-md-12">
                                            ...
                                            >
                                                ...
                                                <input
                                                    ...
                                                    v-model="
                                                        frmDatosCliente.fecha_nacimiento
                                                    "
                                                    :disabled="
                                                        frmDatosCliente.modo ==
                                                            'NO-EDITAR' ||
                                        ...
                                        <div class="form-row col-md-12">
                                            <div
                                                class="form-group col-md-4 col-5"
                                            >
                                                <label class="label-title"
                                                    >AGENCIA</label
                                                >
                                                <input
                                                    ...
                                                    class="form-control center"
                                                    :value="
                                                        frmDatosCliente.agencia
                                                    "
                                                    :disabled="true"
                                                />
                                            </div>
                                            <div
                                                class="form-group col-md-8 col-7"
                                            >
                                                <label class="label-title"
                                                ...
                                                <form autocomplete="off">
                                                    <input
                                                        ...
                                                        class="form-control"
                                                        v-model="
                                                            frmDatosCliente.correo_electronico
                                                        "
                                                        :disabled="
                                                            frmDatosCliente.modo ==
                                                                'NO-EDITAR' ||
                                    ...
                                    <div class="form-row col-md-12">
                                        ...
                                        <div class="form-group col-md-4 col-6">
                                            ...
                                            <select
                                                ...
                                                v-model="
                                                    frmDatosCliente.canal_referencia
                                                "
                                                :disabled="
                                                    frmDatosCliente.modo ==
                                                        'NO-EDITAR' ||
                                            ...
                                            >
                                                ...
                                                <option value="TV Y RADIO">
                                                    TV y radio
                                                </option>
                                                <option
                                                    value="AVISOS PUBLICITARIOS"
                                                >
                                        ...
                                        <div class="form-group col-md-4 col-6">
                                            ...
                                            <input
                                                ...
                                                style="
                                                    font-size: 15px;
                                                    color: var(
                                                        --azulOscuroEmpresarial
                                                    );
                                                    font-weight: bolder;
                                                "
                                                v-model.number="
                                                    frmDatosCliente.monto_maximo
                                                "
                                                @keyup="Redondear"
                                                :disabled="
                                                    frmDatosCliente.modo ==
                                        ...
                                        <div class="form-group col-md-4 col-6">
                                            ...
                                            <select
                                                class="form-control center"
                                                v-model="
                                                    frmDatosCliente.central_riesgo
                                                "
                                                :disabled="
                                                    frmDatosCliente.modo ==
                                                        'NO-EDITAR' ||
                                    ...
                                    <div class="form-group col-md-12 col-12">
                                        <div class="form-check text-right">
                                            <input
                                                ...
                                                v-model="
                                                    frmDatosCliente.reportar_equifax
                                                "
                                                :disabled="
                                                    frmDatosCliente.modo ==
                                                        'NO-EDITAR' ||
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4 col-4">
                                            ...
                                            <select
                                                ...
                                                v-model="
                                                    frmDatosCliente.departamento_id
                                                "
                                                :disabled="
                                                    frmDatosCliente.modo ==
                                                        'NO-EDITAR' ||
                                        ...
                                        >
                                            ...
                                            <form autocomplete="off">
                                                <textarea
                                                    ...
                                                    rows="3"
                                                    v-model="
                                                        frmDatosCliente.referencia_direccion
                                                    "
                                                    :disabled="
                                                        frmDatosCliente.modo ==
                                                            'NO-EDITAR' ||
                            ...
                            >
                                <div
                                    class="smartcenter form-row justify-content-md-center"
                                >
                                    <div
                                ...
                                <div class="form-row">
                                    ...
                                    <div
                                        class="form-group col-md-5 offset-md-1"
                                    >
                                        <label class="label-title"
                                            >OBSERVACIONES</label
                                        >
                ...
                willOpen: async () => {
                    ...
                    return axios
                        ...
                        .then(async (response) => {
                            ...
                            this.frmDatosCliente.direccion =
                                inf_reniec.direccion;
                            this.frmDatosCliente.departamento_id =
                                inf_reniec.ubigeo[0];
                ...
                .then(function (response) {
                    if (response.data.resultado == "EXISTE") {
                        ...
                        Swal.fire({
                            ...
                            title: "¡Ups!",
                            text:
                                "Este cliente ya está registrado en la agencia " +
                                agencia,
                        });
                        return false;
